...
void CMyApp::InitTextures()
{
	...
	m_loc_image = glGetUniformLocation(m_programID, "image");
...
bool CMyApp::Init()
{
	...
	m_eyeLoc = glGetUniformLocation(m_programID, "eyePos");
...
void CMyApp::Render()
{
	...
	glUniform3fv(m_eyeLoc, 1, &eye[0]);
	// feladat - textúra
	glActiveTexture(GL_TEXTURE0);
	glBindTexture(GL_TEXTURE_2D, m_loadedTextureID);
	glUniform1i(m_loc_image, 0);
