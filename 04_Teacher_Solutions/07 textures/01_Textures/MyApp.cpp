...
bool CMyApp::Init()
{
	...
	m_loc_tex_loaded = glGetUniformLocation(m_programID, "texImageLoaded");
	m_loc_tex_generated = glGetUniformLocation(m_programID, "texImageGenerated");
...
void CMyApp::Render()
{
	...
	glUniform1f(m_loc_time, SDL_GetTicks() / 1000.0f);
	...
	glUniform1i(m_loc_tex_loaded, 0);
	
	glActiveTexture(GL_TEXTURE0 + 1);
	glBindTexture(GL_TEXTURE_2D, m_generatedTextureID);
	glUniform1i(m_loc_tex_generated, 1);
