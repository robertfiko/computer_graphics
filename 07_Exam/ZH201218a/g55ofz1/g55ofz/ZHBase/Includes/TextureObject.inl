...
inline void TextureObject<type>::AttachFromFile(const std::string& filename, bool generateMipMap, GLuint role)
{
	...
	// Áttérés SDL koordinátarendszerrol ( (0,0) balfent ) OpenGL textúra-koordinátarendszerre ( (0,0) ballent )
	...
	glTexImage2D(
		role,							// melyik binding point-on van a textúra eroforrás, amihez tárolást rendelünk
		0,								// melyik részletességi szint adatait határozzuk meg
		GL_RGBA,						// textúra belso tárolási formátuma (GPU-n)
