...
bool CMyApp::Init()
{
	...
	Vertex vert[] =
	{
		...
		//          x,  y, z             R, G, B
		{glm::vec3(1, -1, 1), glm::vec3(0, 0, 0)}, //8
		{glm::vec3(2, -1, 1), glm::vec3(1, 0, 0)}, //9
		{glm::vec3(2,  0, 1), glm::vec3(0, 1, 0)}, //10
		{glm::vec3(1, -1, 0), glm::vec3(0, 0, 1)}, //11
		...
		//          x,  y, z             R, G, B
		{glm::vec3(-1,  0, 1), glm::vec3(0, 1, 1)}, //14
		{glm::vec3(-1,  0, 0), glm::vec3(1, 1, 1)}, //15
		{glm::vec3(-1, -1, 1), glm::vec3(0, 0, 0)}, //16
		{glm::vec3( 0, -1, 1), glm::vec3(1, 0, 0)}, //17
		{glm::vec3( 0, -1, 0), glm::vec3(0, 1, 0)}, //18
		{glm::vec3(-1, -1, 0), glm::vec3(0, 0, 1)}, //19
		...
		{glm::vec3(-1, 1, 1), glm::vec3(0, 0, 0)}, //24
		{glm::vec3(-1, 2, 1), glm::vec3(1, 0, 0)}, //25

		//Kieg. 5. kocka - jobb felül
		//          x,  y, z             R, G, B
		{glm::vec3(2, 1, 0), glm::vec3(0, 1, 0)}, //26
		{glm::vec3(1, 2, 0), glm::vec3(0, 0, 1)}, //27
		{glm::vec3(2, 2, 0), glm::vec3(1, 1, 0)}, //28
		{glm::vec3(2, 1, 1), glm::vec3(1, 0, 1)}, //29
		{glm::vec3(2, 2, 1), glm::vec3(0, 1, 1)}, //30
		{glm::vec3(1, 2, 1), glm::vec3(1, 1, 1)}, //31 
...
void CMyApp::Render()
{
	...
	if (resize) {
		...
		scalar = fabs(cosf(sca*M_PI/6.0)) * 1.5 + 0.5;
